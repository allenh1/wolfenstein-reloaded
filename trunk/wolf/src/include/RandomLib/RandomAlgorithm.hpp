 ...
 * and SIMD oriented Fast Mersenne Twister
 * <a href="http://www.math.sci.hiroshima-u.ac.jp/~m-mat/MT/SFMT/index.html">SFMT19937</a>
...
#if !defined(RANDOMALGORITHM_HPP)
...
namespace RandomLib {
   ...
   *
   * The template argument give the type \a RandomType of the "natural" result.
   ...
   * http://randomlib.sourceforge.net/
   **********************************************************************/
  template<class RandomType> class MT19937 {
  public:
    /**
   ...
   *
   * The template argument give the type \a RandomType of the "natural" result.
   * This incorporates the bit width and the C++ type of the result.  The
   * 32-bit and 64-bit versions of SFMT19937 produce the same sequences and the
   * differing only in whether how the state is represented.  The
   ...
   * see http://randomlib.sourceforge.net/
   **********************************************************************/
  template<class RandomType> class SFMT19937 {
  public:
    /**
     * The result RandomType
     **********************************************************************/
  ...
  private:
...
#if HAVE_SSE2 || HAVE_ALTIVEC
    static const Random_u32::type
      magic0 = 0x1fffefUL,
      magic1 = 0x1ecb7fUL,
      magic2 = 0x1affffUL,
      magic3 = 0x1ffff6UL;
    ...
    static const engine_type
      PARITY0 = 1U,
      PARITY1 = width == 32 ? 0U : 0x13c9e68400000000ULL,
      PARITY2 = 0U,
      PARITY3 = width == 32 ? 0x13c9e684UL : 0U;
    /**
  ...
  public:
     ...
     * merely verfies that the state is not all zero.  At the same time,
